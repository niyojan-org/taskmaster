  ...
  useEffect(() => {
    if (resource) {
      setFormData({
        ...
        priority: resource.priority?.toString() || "",
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Update resource metadata. To replace the file itself, use the Replace File action.
          </DialogDescription>
        </DialogHeader>
          ...
          {resource && (
            <div className="p-3 bg-muted rounded-md space-y-2">
              <div className="flex items-start gap-3">
                {resource.fileUrl && resource.type?.startsWith("image") && (
                  <img
